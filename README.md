...
- Для дополнительной проверки на урон и его изменение вы можете подключить интерфейс **ProcessingDamage** который содержит 2 функции, **CanApplyDamage** является дополнительной проверкой на нанесение урона, а с помощью **ModifireDamage** вы можете изменять наносимый урон.
